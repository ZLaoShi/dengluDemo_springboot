...
import com.example.entity.vo.requst.ConfirmResetVO;
        ...
        synchronized (ip.intern()) {
            if(this.verifyLimit(ip)) {
                ...
                stringRedisTemplate.opsForValue()
                        .set(Const.VERIFY_EMAIL_DATA + email, String.valueOf(code), 3, TimeUnit.MINUTES); //验证验证码，三分钟内有效
